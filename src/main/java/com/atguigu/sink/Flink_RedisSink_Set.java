 ...
 * LANGE sensor_2 0 -1查看key的元素列表
 * LANGE sensor_3 0 -1查看key的元素列表
 *
 *  type sensor_1 返回类型 set
 *
 *  smembers snesor_1 查看元素
 *  127.0.0.1:6379> smembers sensor_1
 ...
 *
 */
public class Flink_RedisSink_Set {
    @SneakyThrows
